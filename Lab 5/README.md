...
|-------|-----------|----------|--------------------------|
| 1 | wall following | leftRange to 0.30 m | 0.5, 0.01, 0.01, 0.6 |
| 2 | heading to Gap 1 | yaw to 0 rad (+X) | 2.0, 0.05, 0.01, 0.6 |
| 3 | heading to Gap 2 | yaw to -0.80 rad | 2.0, 0.05, 0.01, 0.6 |
| 4 | through Gap 2 | yaw to -0.80 rad | 2.0, 0.05, 0.01, 0.6 |
| 5 | to charger | yaw to -1.45 rad | 2.0, 0.05, 0.01, 0.6 |
| 6 | stop | -- | -- |
...
|----------|-------|------------|
| `odom_landmark1` (Y) | 1.38 | stage 1 to 2 |
| `odom_landmark2` (X) | 0.95 | stage 2 to 3 |
| `odom_landmark3` (X) | 1.55 | stage 3 to 4 |
| `odom_landmark4` (X) | 1.95 | stage 4 to 5 |
| `odom_landmark5` (Y) | 0.33 | stage 5 to 6 |
